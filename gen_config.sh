...
printf "\n" >> "${DestFile}"
printf "%s\n" 'bld/OSGLUSD2.o : src/OSGLUSD2.c src/STRCNENG.h cfg/STRCONST.h src/INTLCHAR.h src/COMOSGLU.h src/CONTROLM.h cfg/CNFGGLOB.h' >> "${DestFile}"
